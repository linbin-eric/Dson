...
public class MapDeserializeDescriptor implements DeserializeDescriptor
{
	...
	public void initialize(Type type, Deserializer deserializer)
	{
		if (type instanceof ParameterizedType)
		{
			...
			{
				keyDescriber = deserializer.describe(Object.class);
			}
			else if (keyType instanceof Class<?> || keyType instanceof ParameterizedType)
			{
				keyDescriber = deserializer.describe(keyType);
			}
			else
			{
			...
			{
				valueDescriber = deserializer.describe(Object.class);
			}
			else if (valueType instanceof Class || valueType instanceof ParameterizedType)
			{
				valueDescriber = deserializer.describe(valueType);
			}
			else
			{
		...
		{
			keyDescriber = deserializer.describe(String.class);
			valueDescriber = deserializer.describe(Object.class);
