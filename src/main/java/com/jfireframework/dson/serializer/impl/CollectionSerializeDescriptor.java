...
public class CollectionSerializeDescriptor implements SerializeDescriptor
{
    ...
    {
        void initialize(Type elementType, Map<Type, SerializeDescriptor> map);
    ...
    public void initialize(Serializer serializer, Type type, Map<Type, SerializeDescriptor> map)
    {
        ...
        else if (type instanceof ParameterizedType)
        {
            ...
            elementSerializer.initialize(elementType, map);
        }
        else
        {
            throw new IllegalArgumentException();
    ...
    class FinalElementSerializer implements ElementSerializer
    {
        ...
        @Override
        public void initialize(Type elementType, Map<Type, SerializeDescriptor> map)
        {
            serializeDescriptor = serializer.describe(elementType, map);
        }
